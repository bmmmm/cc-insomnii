...
### Added
- Extracted from claudii. Bedtime shaming with 5 escalation modes (0-5), rainbow chase
  animation, breathing pulse, motivation messages.
...
- Configurable via `~/.config/insomnii/config.json` and env vars
...
[Unreleased]: https://github.com/bmmmm/insomnii/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/bmmmm/insomnii/releases/tag/v0.1.0
